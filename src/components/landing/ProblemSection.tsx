  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`relative bg-card/60 backdrop-blur-sm rounded-2xl p-7 border transition-all duration-500 text-center overflow-hidden ${
      ...
      >
        ...
        <motion.div
          ...
          className="w-14 h-14 mx-auto mb-5 rounded-2xl bg-destructive/10 flex items-center justify-center"
        >
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center" style={{ backfaceVisibility: 'hidden', transform: 'rotateX(180deg)' }}>
            <p className="font-display text-2xl font-black text-destructive">{item.stat}</p>
    ...
    <section id="problema" className="py-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mb-5">{title}</h2>
